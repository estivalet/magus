...
*/
/* footer */
.footer { position:absolute;width:100%;background:#335c91 url(../layout7/images/footer_bg.jpg) repeat-x top; }

.footer .bgr { padding-right:24px; background:url(../layout7/images/footer_bg_right.jpg) no-repeat top right;}
...
.content_res { padding:32px 32px 32px 32px;}
/*
...
.gadget a.colourbutton span span { padding:6px 12px 8px 6px;} 
...
<div class="top_header">
                            ...
                            <div class="inner-form">
                                ...
                                <div class="msg msg-info"><p>I'm an <strong>info</strong> message and I'm proud of it!</p></div>
                                    <dl>
                                        ...
                                        <dd>
                                            <input class="txt error" id="some3" name="some3" value="error" type="text">
                                            <small>An error description.</small>
                                        </dd>
                                    
                                        <dt class="ttop"><label for="some2">Textarea:</label></dt>
  ...
  <div class="footer">
     <div class="bgr">
      <img src="../layout7/images/footer_bg_left.jpg" alt="Logo" class="logo" height="99" width="430"/>
      <div class="f_right">
        <ul>
        ...
        <div class="clr"></div>
        <p><a href="http://www.dreamtemplate.com"><img src="../layout7/images/footer_icon.gif" alt="picture" height="23" width="27"></a>Website Administration by <a href="http://www.webappskins.com"><span>WebAppSkins</span></a></p>
      </div>
      <div class="clr"></div>
    </div>
  </div>
