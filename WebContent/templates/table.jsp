...
<html>
  ...
  <body>
    ...
    <h2>Pure CSS Fixed Header Variable Width Table - different content</h2>
    <div class="fixed-table-container">
      <div class="header-background"> </div>
      <div class="fixed-table-container-inner">
        <table cellspacing="0">
        ...
        <!-- This markup is just like the first except the content is different extra wrap div-->
    <h2>Pure CSS Fixed Header Variable Width Table with extra wrap div</h2>
    <div class="fixed-table-container">
      <div class="header-background"> </div>
      <div class="fixed-table-container-inner extrawrap">
        <table cellspacing="0">
          <thead>
            <tr>
              <th class="first">
                <div class="extra-wrap"><div class="th-inner">First</div></div>
              </th>
              <th>
                <div class="extra-wrap"><div class="th-inner second">Second and Longer</div></div>
              </th>
              <th>
                <div class="extra-wrap"><div class="th-inner">Third</div></div>
              </th>
            </tr>
          </thead>
          <tbody>
    ...
    <div class="fixed-table-container hidden-head">
      ...
      <div class="fixed-table-container-inner">
        ...
        <!-- double wrap as Zupa suggests-->
    <h2>Pure CSS Fixed Header Variable Width Table - Center Aligned (Zupa style)</h2>
    <div class="fixed-table-container zupa">
      ...
      <div class="fixed-table-container-inner">
        <table cellspacing="0">
          <thead>
            <tr>
              <th class="first">
                                <div class="zupa1">
                                    <div class="th-inner"><span>First</span></div>
                                </div>
              </th>
              <th>
                                <div class="zupa1">
                                    <div class="th-inner second"><span>Second and Longer</span></div>
                                </div>
              </th>
              <th>
                                <div class="zupa1">
                                    <div class="th-inner"><span>Third</span></div>
                                <div>
              </th>
            </tr>
          </thead>
        ...
        <!-- double wrap as Zupa suggests-->
    <h2>Pure CSS Fixed Header Variable Width Table - Center Aligned (Zupa style) with hidden header</h2>
    <div class="fixed-table-container zupa hidden-head">
      <div class="header-background"> </div>
      <div class="fixed-table-container-inner">
        <table cellspacing="0">
          <thead>
            <tr>
              ...
              <th>
                                <div class="zupa1">
                                    <div class="th-inner second"><span>Second and Longer than Content in the Column</span></div>
                                </div>
              </th>
              <th>
                                <div class="zupa1">
