...
color:#a4c5ee; background:#335c91 url(header_bg_right.jpg) no-repeat top right; min-width:1220px;
  ...
  background: linear-gradient(to bottom, #333333 0%, #141414 100%);    
    margin:0; padding:0; width:100%; font:normal 12px/1.5em Arial, Helvetica, sans-serif;
}
...
<div class="top_header">
    <div class="header_logo"  style="position:absolute;left:18px;right:0px;">
...
<div id='cssmenu'  style="position:absolute;left:18px;right:0px;top:130px;background-color:red;">
<ul>
