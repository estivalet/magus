    ...
    <div class="container">
        ...
        <div class="header">
            <div class="header_res">
                <a href="http://www.templateaccess.com/demos/adminskins/vividadmin/index.html"><img src="css/vividadmin/images/logo.jpg" alt="Logo"
                    class="logo" height="124" width="260"></a>
                <div class="rbuts">
                    <a href="#dialog1" name="modal" id="jsi_login"><img src="css/vividadmin/images/button_login.jpg" alt="Log In" height="40" width="120"></a>
                    <a href="#dialog2" name="modal" id="jsi_faq"><img src="css/vividadmin/images/button_faq.jpg" alt="F.A.Q." height="40" width="107"></a>
                    <div class="clr"></div>
                </div>
                <div class="clr"></div>
                <ul class="menu">
                ...
                <p class="personalinfo">
                    <a href="#"><strong>37</strong></a> incoming messages &nbsp;&nbsp; <a href="#"><img src="css/vividadmin/images/button_logout.jpg"
                    ...
                    <div class="leftblock vertsortable ui-sortable">
                        ...
                        <div class="gadget jsi_gv">
                            ...
                            <div class="gadget_content">
                                <p class="timeclock">
                                    <img src="css/vividadmin/images/icon_clock2.gif" height="26" width="26"><span id="tm">11 08</span>
                                </p>
                            </div>
                        </div>
                        <!--gadget calendar -->
        ...
        <div class="footer">
            <div class="footer_res">
                <a href="#"><img src="css/vividadmin/images/logo_f.jpg" alt="logo" class="logo" height="114" width="260"></a>
                <div class="right_footer">
                    ...
                    <div class="clr"></div>
                    <p>
                        <a href="http://www.dreamtemplate.com/"><img src="css/vividadmin/images/icon_site.jpg" alt="picture" height="22" width="27"></a>Website
            ...
            <div id="dialog1" class="window">
                <div class="gadget jsi_gd">
                    <div class="gadget_title">
                        <a href="#" class="close closegadget"><img src="css/vividadmin/images/spacer.gif" height="35" width="19"></a>
                        <h3>Thank you for</h3>
                    </div>
                    <div class="gadget_content">
                        <p>
                ...
                <div class="gadget jsi_gd">
                    ...
                    <div class="gadget_content">
                        ...
                        <p class="err_mes jsi_mes_green">
                            <img src="css/vividadmin/images/pimpa_green.gif" class="pimpa" height="13" width="13"> success message <a href="#"
                                class="close_mess"><img src="css/vividadmin/images/spacer.gif" height="38" width="24"></a>
                        </p>
                        <p class="err_mes jsi_mes_red">
                            <img src="css/vividadmin/images/pimpa_red.gif" class="pimpa" height="13" width="13"> critical message <a href="#"
                                class="close_mess"><img src="css/vividadmin/images/spacer.gif" height="38" width="24"></a>
                        </p>
