...
/***************************************************************************
 * Table  : MW_DATABASE
 * Purpose: Store MagusWeb supported databases.
 ***************************************************************************/
DROP TABLE IF EXISTS MW_DATABASE CASCADE;
/*CREATE TABLE MW_DATABASE
(
  id integer GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) not null, 
  name VARCHAR(40) not null,
  CONSTRAINT db_uniq_name unique(name)
);*/

/***************************************************************************
 * Table  : MW_SERVER
 * Purpose: Store MagusWeb supported servers.
 ***************************************************************************/
DROP TABLE IF EXISTS MW_SERVER CASCADE;
/*CREATE TABLE MW_SERVER
(
  id integer GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) not null, 
  NAME VARCHAR(80) not null,
  CONSTRAINT srv_uniq_name unique(name)
);*/
...
(
  ...
  java_package varchar(60) null,
  class_path varchar(500) null,
  src_folder varchar(60) null,
...
(
  ...
  password varchar(20),
  CONSTRAINT FK_APPSERV_APP FOREIGN KEY (app_id) REFERENCES MW_APPLICATION (ID)
  /*CONSTRAINT FK_APPSERV_SER FOREIGN KEY (server_id) REFERENCES MW_SERVER (ID)*/
);
...
(
  ...
  /*CONSTRAINT FK_APPDAT_DB FOREIGN KEY (db_id) REFERENCES MW_DATABASE (ID)*/
);
...
/***************************************************************************
 * Table      : MW_PARAMETER
 * Purpose    : Store parameter values for Magus operation
 ***************************************************************************/
DROP TABLE IF EXISTS MW_PARAMETER CASCADE;
/*CREATE TABLE MW_PARAMETER
(
  id integer GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) not null,
  parameter varchar(100) not null,
  value varchar(500) not null,
  description varchar(2000) null,
  CONSTRAINT param_uniq_name unique(parameter)
);*/
