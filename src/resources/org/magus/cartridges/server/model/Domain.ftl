...
public class ${clazzDomainName} implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ${clazzDomainName})) {
            return false;
        }
        ${clazzDomainName} other = (${clazzDomainName}) obj;
        <#list allColumns as column><#t>
    ...
    public String toXML() {
        String xml = "<${clazzDomainName?uncap_first}>";
        <#list allColumns as column><#t>
        ...
        xml += "</${clazzDomainName?uncap_first}>";
