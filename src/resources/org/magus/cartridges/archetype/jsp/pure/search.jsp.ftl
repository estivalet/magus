    ...
    <div class="container">
        <div class="table-container">
            <div class="table-header">
                <div class="table-header-text">List of ${clazz.getAlias(true)}&nbsp;<a href="#" onclick="edit('','${clazz.getAlias(true)}Action','create')"><img style="vertical-align:text-top" src="css/plus.png"/></a></div>
            </div>
