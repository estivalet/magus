...
public class DatabaseInserter<T> extends AbstractDatabaseHandler<T> {
	...
	public DatabaseInserter(Class<T> type, DatabaseConnecter databaseConnecter) {
	 ...
	 */
	public void insertObjects(List<T> list) throws SQLException, SecurityException, IllegalArgumentException, InstantiationException, IllegalAccessException, IntrospectionException, InvocationTargetException {
