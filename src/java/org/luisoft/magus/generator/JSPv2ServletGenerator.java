 ...
 * 
 */
public class JSPv2ServletGenerator {
     ...
     * @throws Exception
     */
    public JSPv2ServletGenerator(IContext context) throws Exception {
    ...
    private void copyFiles() throws IOException {
        ...
        File src = new File(appPath + "/" + mc.getParameter("archetype.files.path") + "jspv2/" + template);
    ...
    private void generateCode() throws Exception {
        ...
        String tplPath = "archetype/jspv2/" + app.getTemplate();
        ...
        for (TableWrapper table : app.getTables()) {
            ...
            executeDecorator(new JSPServletDecorator(app, table, context, tplPath + "/ActionCommand.java.ftl", javaPath + "/server/commands/" + table.getCamelCaseName(true) + "ActionCommand.java"));
