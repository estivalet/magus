...
public class DomainResourceDecorator extends TableDecorator {
     ...
     * @param context
     */
    public DomainResourceDecorator(Application app, TableWrapper table, IContext context) {
        super(app, context, "resource", "DomainResource", table, "Resource");
    }
