...
/**
 * Creates a JSP page to update fields in the table.
 * 
 * @author 88758559000
 */
public class UpdatePageDecorator extends FreemarkerDecorator {
     ...
     * @param context
     */
    public UpdatePageDecorator(Application app, TableWrapper table, IContext context) {
        super(app, context);
        this.t = table;
    }
    ...
    protected String getTemplate() {
        return "web/template/" + app.getTemplate() + "/pages/update.ftl";
    }
    ...
    public String getFullPath() {
        ...
        return path + "/" + t.getAlias() + "/update.jsp";
    }
    ...
    protected void decorateIt() {
        ...
        model.put("pks", t.getPrimaryKeyColumns());
